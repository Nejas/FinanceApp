...
data class Sizing(
    ...
    val transactionDatePickerActionBarHeight: Dp = 60.dp,
    val transactionTimePickerSheetHeight: Dp = 243.dp,
    val transactionTimePickerHeaderHeight: Dp = 40.dp,
    val transactionTimePickerInputHeight: Dp = 95.dp,
    val transactionTimePickerActionsHeight: Dp = 68.dp,
    val transactionTimePickerActionIconSize: Dp = 40.dp,
    val transactionTimePickerActionsWidth: Dp = 215.dp,
    val transactionTimePickerCancelButtonWidth: Dp = 99.dp,
    val transactionTimePickerApplyButtonWidth: Dp = 108.dp,
    val transactionTimePickerActionButtonHeight: Dp = 48.dp,
    val settingsRowHeight: Dp = 64.dp,
    val settingsPickerRowHeight: Dp = 56.dp,
    val settingsThemeCardHeight: Dp = 125.dp,
    val settingsThemeCardCorner: Dp = 16.dp,
    val settingsThemePreviewHeight: Dp = 60.dp,
    val settingsThemePreviewCorner: Dp = 8.dp,
    val settingsLeadingFrame: Dp = 32.dp,
    val settingsLeadingIcon: Dp = 24.dp,
    val settingsTrailingIcon: Dp = 24.dp,
    val pinCodeDot: Dp = 16.dp,
    val biometricIconContainer: Dp = 80.dp,
    val biometricIcon: Dp = 48.dp,
    val biometricToggleRowHeight: Dp = 64.dp,
    val biometricToggleRowCorner: Dp = 16.dp,
