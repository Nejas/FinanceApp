...
data class Spacing(
    ...
    val sheetButtonHorizontal: Dp = 20.dp,
    val sheetButtonTop: Dp = 20.dp,
    val sheetButtonBottom: Dp = 16.dp,
    val sheetFloatingButtonBottom: Dp = 9.dp,
    val currencySheetBottom: Dp = 34.dp,
    val sheetCalendarHorizontal: Dp = 24.dp,
    val categorySheetTitleTop: Dp = 16.dp,
    val categorySheetSearchTop: Dp = 12.dp,
    val categorySheetSearchBottom: Dp = 12.dp,
    val categorySheetSearchHorizontal: Dp = 24.dp,
    val categorySheetSearchContentHorizontal: Dp = 24.dp,
    val categorySheetSearchContentVertical: Dp = 5.dp,
    val categorySheetRowHorizontal: Dp = 20.dp,
    val categorySheetRowGap: Dp = 16.dp,
    val categorySheetListBottom: Dp = 16.dp,
    ...
    val transactionDatePickerCloseStart: Dp = 12.dp,
    val transactionDatePickerCloseTop: Dp = 24.dp,
    val transactionDatePickerHeaderTextStart: Dp = 64.dp,
    val transactionDatePickerActionsHorizontal: Dp = 24.dp,
    val transactionDatePickerActionsGap: Dp = 12.dp,
    val transactionTimePickerHeaderHorizontal: Dp = 24.dp,
    val transactionTimePickerHeaderTop: Dp = 24.dp,
    val transactionTimePickerInputHorizontal: Dp = 24.dp,
    val transactionTimePickerContentGap: Dp = 20.dp,
    val transactionTimePickerActionsStart: Dp = 12.dp,
