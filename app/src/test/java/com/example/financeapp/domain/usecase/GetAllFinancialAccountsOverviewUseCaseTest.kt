...
class GetAllFinancialAccountsOverviewUseCaseTest {

    @Test
    fun invoke_returnsAllAccountsAndCalculatesTotalForRequestedCurrency() = runTest {
        val accounts = listOf(
        ...
        val useCase = GetAllFinancialAccountsOverviewUseCase(
